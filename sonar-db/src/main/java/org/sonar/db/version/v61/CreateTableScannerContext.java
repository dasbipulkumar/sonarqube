  ...
  public void execute(Context context) throws SQLException {
    context.execute(
      new CreateTableBuilder(getDialect(), "ce_scanner_context")
        ...
        .addColumn(newBigDecimalColumnDefBuilder().setColumnName("created_at").setIsNullable(false).build())
        .addColumn(newBigDecimalColumnDefBuilder().setColumnName("updated_at").setIsNullable(false).build())
        .build());
  }
}
